...
class Base64LargeXmlTests {
    ...
    void testProcessingOfBase64EncodedXml() throws URISyntaxException, IOException {
        ...
        Document doc = DocumentParsers.builder().removingInterElementWhitespace().build().parse(new InputSource(new ByteArrayInputStream(xmlString.getBytes(UTF_8))));
    ...
    void testProcessingOfBase64EncodedXmlAttribute() throws URISyntaxException, IOException {
        ...
        Document wrapperDoc = DocumentParsers.builder().removingInterElementWhitespace().build().parse(new InputSource(new ByteArrayInputStream(wrapperXmlString.getBytes(UTF_8))));
        ...
        Document nestedDoc = DocumentParsers.builder().removingInterElementWhitespace().build().parse(new InputSource(new ByteArrayInputStream(base64DecodedChildElemTextContent)));

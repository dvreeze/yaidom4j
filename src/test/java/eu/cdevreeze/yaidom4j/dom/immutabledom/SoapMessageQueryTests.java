...
class SoapMessageQueryTests {
    ...
    void testQueryingUsingElementSteps() {
        ...
        String departing3 = soapMessage.documentElement()
                ...
                .flatMap(
                        childElements(hasLocalName("Body"))
                                .then(childElements(hasLocalName("itinerary")))
                                .then(childElements(hasLocalName("departure")))
                                .then(childElements(hasLocalName("departing")))
                )
                .findFirst()
                .map(Element::text)
                .orElseThrow();
        ...
        String departing4 = soapMessage.documentElement()
                .select(
                        selfElement(hasLocalName("Envelope"))
                                .then(childElements(hasLocalName("Body")))
                                .then(childElements(hasLocalName("itinerary")))
                                .then(childElements(hasLocalName("departure")))
                                .then(childElements(hasLocalName("departing")))
                )
        ...
        String departing5 = soapMessage.documentElement()
                .select(
                        descendantElementsOrSelf(hasLocalName("Envelope"))
                                .then(topmostDescendantElements(hasLocalName("Body")))
                                .then(topmostDescendantElementsOrSelf(hasLocalName("itinerary")))
                                .then(descendantElements(hasLocalName("departure")))
                                .then(descendantElementsOrSelf(hasLocalName("departing")))
                )
                .findFirst()
                .map(Element::text)
                .orElseThrow();
